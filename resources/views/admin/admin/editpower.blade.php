...
<body>
		...
		@endif
	<form action="{{route('doeditpower',['id'=>$role->id])}}" method="post">
	{{csrf_field()}}
		...
		<div class="left_Competence_add">
			...
			<div class="Competence_add">
				<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 角色名称 </label>
					<div class="col-sm-9"><input type="text" value="{{$role->role_name}}" id="form-field-1" placeholder="" name="role_name" class="col-xs-10 col-sm-5"></div>
				</div>
				<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 角色描述 </label>
					<div class="col-sm-9">
						<textarea  class="form-control" name="role_describe" id="form_textarea" placeholder="" >{{$role->role_describe}}</textarea>
				...
				<dl class="permission-list">
					...
					<dd>
						<dl class="cl permission-list2">
							<dt>                 
								<label class="middle"><input type="checkbox" value="{{$k['id']}}" class="ace" @if(in_array($k['id'],$ro_poid)) checked="checked" @endif name="power_mg[]" id="id-disable-check">        
							...
							<dd>
								...
								@foreach($k['three'] as $b)
                                   <label class="middle">
                                        ...
                                        <input type="checkbox"  @if(in_array($b['id'],$ro_poid)) checked="checked" @endif value="{{$b['id']}}" class="ace"  name="power_sg[]" >
