			...
			<tr>
             ...
             <tbody>
			  ...
			  <tr>
				...
				<td>
                 <a title="编辑"  href="{{route('editpower',['id'=>$v->id])}}"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>        
                 <a title="删除"  href="{{route('delpower',['id'=>$v->id])}}"  class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
				</td>
			   </tr>
				@endforeach						
		      </tbody>
