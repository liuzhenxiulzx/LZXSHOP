...
<body>
<form action="{{route('doaddbrand')}}" method="post"  enctype="multipart/form-data">
{{csrf_field()}}
<div class=" clearfix">
   ...
   <ul class="add_conent">
    ...
    <li class=" clearfix"><label class="label_name">品牌图片：</label>
        <input type="file" name="brand_img" id="">
         ...
         <li class=" clearfix"><label class="label_name"><i>*</i>所属地区：</label> <input name="colony" type="text" class="add_text" style="width:120px"/></li>
         <li class=" clearfix"><label class="label_name">品牌描述：</label> 
            <textarea name="describe" class="textarea" onkeyup="checkLength(this);"></textarea>
