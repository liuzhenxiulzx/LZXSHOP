...
<!-- <div id="scrollsidebar" class="left_Treeview">
   ...
   <div class="type_title">添加商品</div>
	...
	<form action="{{route('doeditproduct',['id'=>$product->id])}}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
    {{csrf_field()}}
        
		<div class="clearfix cl">
         <label class="form-label col-2">产品标题：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="{{$product->pro_title}}" placeholder="" id="" name="pro_title"></div>
		</div>
		<div class=" clearfix cl">
         <label class="form-label col-2">简略标题：</label>
	     <div class="formControls col-10"><input type="text" class="input-text" value="{{$product->brief_title}}" placeholder="" id="" name="brief_title"></div>
        </div>
        <div class="clearfix cl">
			<label class="form-label col-2">促&nbsp;&nbsp;&nbsp;&nbsp;销：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="{{$product->promotion}}" placeholder="" id="" name="promotion">
			</div>
		</div>
        <div class="clearfix cl">
         <label class="form-label col-2">产品名称：</label>
		 <div class="formControls"><input type="text" class="input-text" value="{{$product->pro_name}}" placeholder="" id="" name="pro_name"></div>
        </div>
       
        <div class="clearfix cl">
         <label class="form-label col-2">父级ID：</label>
		    <div class="formControls">
               
                <select name="parent_id" id="">
                   
                        @if($k['id']=$classid){
                             <option value="{{$class->id}}">{{$class->catName}}</option>
                        }else{
                            @foreach($data as $k)
                            <option value="{{$k['id']}}">{{str_repeat('-',$k['level']*4)}}{{$k['catName']}}</option>
                            @endforeach;
                        }
                        @endif;
                </select>
		...
		<div class=" clearfix cl">
			...
			<div class="formControls col-2"><input type="text" class="input-text" value="{{$product->pro_number}}" placeholder="" id="" name="pro_number"></div>
            </div>
			<div class="Add_p_s">
             <label class="form-label col-2">产&nbsp;&nbsp;&nbsp;&nbsp;地：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="{{$product->area}}" placeholder="" id="" name="area"></div>
			</div>
        
             <div class="Add_p_s">
             <label class="form-label col-2">产品重量：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="{{$product->weight}}" placeholder="" id="" name="weight" >kg</div>
			</div>
            
            <div class="Add_p_s">
             <label class="form-label col-2">产品价格：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="{{$product->price}}" placeholder="" id="" name="price" >元</div>
			</div>
		</div>
