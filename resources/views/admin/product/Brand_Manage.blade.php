  ...
  <div id="brand_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="{{route('addbrand')}}"  title="添加品牌" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加品牌</a>
       ...
       <table class="table table-striped table-bordered table-hover" id="sample-table">
		<thead>
		 <tr>
				...
				<th width="80px">ID</th>
				<th width="80px">排序</th>
				<th width="700px">品牌LOGO</th>
				<th width="160px">品牌名称</th>
				<th width="200px">所属地区/国家</th>
	...
	<tbody>
       @foreach($Brand as $v)
		<tr>
          ...
          <td width="50px">{{$v->brand_order}}</td>
          <!-- <td><img src=""  width="130"/></td> -->
          <td><a href="">{{$v->brand_image}}</a></td>
          <td><a href="javascript:ovid()" name="Brand_detailed.html" style="cursor:pointer" class="text-primary brond_name" onclick="generateOrders('561');" title="玉兰油OLAY">{{$v->brandName}}</a></td>
          <td>{{$v->colony}}</td>
          <td class="text-l">{{$v->brand_describe}}</td>
          <td>{{$v->created_at}}</td>
          <td class="td-manage">
                <!-- <a onClick="member_stop(this,'10001')"  href="javascript:;" title="停用"  class="btn btn-xs btn-success"><i class="icon-ok bigger-120"></i></a>  -->
                <a href="{{ route('editbrand',['id'=>$v->id]) }}"  class="btn btn-xs btn-info" >编辑<i class="icon-edit bigger-120"></i></a> 
                <a href="{{ route('deletebrand',['id'=>$v->id]) }}" onclick="return confirm('确定要删除吗？');" class="btn btn-xs btn-warning" >删除<i class="icon-trash  bigger-120"></i></a>
