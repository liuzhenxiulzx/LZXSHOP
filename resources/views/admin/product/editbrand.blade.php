...
<body>
<form action="{{route('doeditbrand',['id'=>$allbrand->id])}}" method="post"  enctype="multipart/form-data">
{{csrf_field()}}
<div class=" clearfix">
 ...
 <div class="left_add">
   ...
   <ul class="add_conent">
    <li class=" clearfix"><label class="label_name"><i>*</i>品牌名称：</label> <input name="brandName" type="text" class="add_text" value="{{$allbrand->brandName}}" /></li>
    <li class=" clearfix"><label class="label_name"><i>*</i>品牌序号：</label> <input name="brand_order" type="text" class="add_text" style="width:80px" value="{{$allbrand->brand_order}}" /></li>
    <li class=" clearfix"><label class="label_name">品牌图片：</label>
        <input type="file" name="brand_img" id="">
            
            <span>{{$allbrand->brand_image}}</span>
           <!-- <div class="demo l_f">
         ...
         <li class=" clearfix"><label class="label_name"><i>*</i>所属地区：</label> <input name="colony" type="text" value="{{$allbrand->colony}}" class="add_text" style="width:120px"/></li>
         <li class=" clearfix"><label class="label_name">品牌描述：</label> 
            <textarea name="describe" class="textarea" onkeyup="checkLength(this);">{{$allbrand->brand_describe}}</textarea>
