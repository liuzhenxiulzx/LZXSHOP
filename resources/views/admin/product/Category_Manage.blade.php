...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
       ...
       <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='vassets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
...
<!---->
 <iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO  SRC="{{route('Admincategoryadd')}}" class="page_right_style"></iframe>
 </div>
</div>
</body>
</html>
