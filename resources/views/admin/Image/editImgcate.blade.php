...
<div class="clearfix" id="add_picture">
	...
	<form action="{{route('doeditImgcate',['id'=>$imgcate->id])}}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
    {{csrf_field()}}
		<div class="clearfix cl">
         	<label class="form-label col-2">分类名称:</label>
			 <div class="formControls col-2">
				<input type="text" class="input-text" value="{{$imgcate->catName}}" placeholder="" id="" name="catName">
			</div>
		</div>
		<div class="clearfix cl">
         	<label class="form-label col-2">分类说明:</label>
			 <div class="formControls col-2">
                <textarea name="Explain" id="" cols="30" rows="10">{{$imgcate->Explain}}</textarea>
			</div>
		</div>
