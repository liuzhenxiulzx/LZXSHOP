...
<div class="page-content clearfix">
 <div class="sort_style">
     <div class="border clearfix">
       <span class="l_f">
        <a href="{{route('AdminaddImageclass')}}" id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加分类</a>
  ...
  <div class="sort_list">
	...
	@foreach($imgcate as $v)
      <tr>
       ...
       <td>{{$v->created_at}}</td>
       <td class="td-manage">
        <a title="编辑" href="{{route('editImgcate',['id'=>$v->id])}}"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
        <a title="删除" href="{{route('delectImgcate',['id'=>$v->id])}}"  onclick="return confirm('确定要删除吗？');"  class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
