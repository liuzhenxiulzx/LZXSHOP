...
<div class="clearfix" id="add_picture">
	...
	<form action="{{route('doAdmineditblogcate',['id'=>$blog->id])}}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
    {{csrf_field()}}
		<div class="clearfix cl">
         	<label class="form-label col-2">分类名称:</label>
			 <div class="formControls col-2">
                    <input type="text" name="catName" id="" value="{{$blog->catName}}">
			</div>
		</div>
		...
		<div class="clearfix cl">
			 ...
			 <div class="formControls col-2">
                <textarea name="abstract" id="" cols="30" rows="10">{{$blog->abstract}}</textarea>
			</div>
		</div>
