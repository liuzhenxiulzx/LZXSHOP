...
<body>
        ...
        <div class="margin clearfix">
            ...
            <form action="{{route('doaddblog')}}" method="post"  enctype="multipart/form-data">
               {{csrf_field()}}    
                    ...
                    <ul>
                        <li class="clearfix Mandatory">
                            ...
                            <span class="formControls col-10">
                                <input name="blog_title" type="text" id="form-field-1" class="col-xs-10 col-sm-5 ">
                            </span>
                        </li>
                        <li class="clearfix Mandatory"><label class="label_name"><i>*</i>文章简介:</label>
                            <span class="formControls col-10">
                                <input name="blog_abstract" type="text" id="form-field-1" class="col-xs-10 col-sm-6 ">
                            </span>
                        </li>                       
