...
<div class="clearfix" id="add_picture">
	...
	<form action="{{route('Admindoaddvip')}}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
    {{csrf_field()}}
		<div class="clearfix cl">
         	<label class="form-label col-2">用户名：</label>
			 <div class="formControls col-2">
				<input type="text" class="input-text" value="" placeholder="" id="" name="vipname">
			</div>
		</div>
		<div class="clearfix cl">
        ...
        <div class="clearfix cl">
			...
			<div class="formControls col-2">
				<input type="text" class="input-text" value="" placeholder="" id="" name="home_address">
			</div>
		</div>
		<div class="clearfix cl">
			...
			<div class="formControls col-2">
				<select name="grade_ID" id="">
					@foreach($grade as $v)
					<option value="{{$v->id}}">{{$v->rankName}}</option>
					@endforeach;
				</select>
			</div>
		</div>
