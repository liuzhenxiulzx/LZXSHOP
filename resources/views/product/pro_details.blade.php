            ...
            <div class="sui-navbar">
                <div class="navbar-inner">
                    <ul class="sui-nav ">
                        ...
                        <li><a href="">{{$a}}</a></li>
                        @endforeach
                        <li><a href="#tab-two" data-toggle="tab"></a></li>
                        <li><a href="#tab-three" data-toggle="tab"></a></li>
                        <li><a href="#tab-four"></a></li>
                        <!-- <li><a href="#tab-five"></a></li> -->
                        <!-- <li><a href="#tab-six"></a></li> -->
                        <!-- <li><a href="#tab-seven"></a></li> -->
                        <!-- <li><a href="#tab-eight"></a></li> -->
                    </ul>
        ...
        <div class="default-list">
            ...
            <div class="goods-list">
                <ul class="yui3-g" id="goods-list">
                    ...
                    <li class="yui3-u-1-4">
                        <div class="list-wrap">
                            <div class="p-img"><img src="{{ URL::asset('./uploads/'.$v->pro_image) }}" alt=''></div>
                            <div class="price"><strong><em>¥</em> <i>{{$v->price}}</i></strong></div>
                            <div class="attr"  id="goods_title"><em>{{$v->pro_title}}</em></div>
                            <div class="cu" id="goods_cx"><em><span>促</span>{{$v->promotion}}</em></div>
                            <div class="operate">
                                <a href="{{route('detail',['id'=>$v->id])}}" target="_blank" class="sui-btn btn-bordered btn-danger">加入购物车</a>
